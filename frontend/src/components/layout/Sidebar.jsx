...
const NAV = {
  [ROLES.ADMIN]: [
    ...
    { icon: SlidersHorizontal, label: 'Salary Structure', path: '/payroll/salary-structure' },
    { icon: FileText,          label: 'Payslip',          path: '/payslip'              },
    { icon: BarChart2,         label: 'Analytics',        path: '/analytics'            },
    { icon: ShieldCheck,       label: 'Payroll Rules',    path: '/admin/payroll-rules'  },
    { icon: Building2,         label: 'Configurations',   path: '/admin/configurations' },
  ...
  [ROLES.HR]: [
    ...
    { icon: CalendarDays,      label: 'Leave Allocation', path: '/hr/leave-allocation'  },
    { icon: BarChart2,         label: 'Analytics',        path: '/analytics'            },
  ],
  [ROLES.PAYROLL]: [
    { icon: MonitorSmartphone, label: 'Status Board',     path: '/status-board'         },
