...
export function adaptEmployee(e, idx = 0) {
  ...
  return {
    ...
    department:      e.department_id ? (_deptCache[e.department_id] || `Dept #${e.department_id}`) : 'Unassigned',
    departmentId:    e.department_id,
    designation:     e.designation_id ? (_desigCache[e.designation_id] || `Desig #${e.designation_id}`) : 'No Title',
