...
class Employee(Base):
    ...
    salary       = relationship("SalaryStructure", back_populates="employee", cascade="all, delete-orphan", uselist=False)
    attendances  = relationship("Attendance", back_populates="employee", cascade="all, delete-orphan")
    leave_apps   = relationship("LeaveApplication", back_populates="employee", cascade="all, delete-orphan")
    allocations  = relationship("LeaveAllocation", back_populates="employee", cascade="all, delete-orphan")
